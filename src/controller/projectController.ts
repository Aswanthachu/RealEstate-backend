// import { Body, Controller, Delete, Example, Get, Middlewares, Path, Post, Put, Route, Security, Tags } from 'tsoa'
...
//   @Post()
//   @Example(example)
//   @Middlewares(validate(validationSchema.projectPostSchema as JSONSchemaType<any>))
//   public async addProject(@Body() projectData: projectType): Promise<{ data?: any; error?: string }> {
//     try {
//       const [response, error, httpStatus] = await projectRepo.addProject(projectData)
